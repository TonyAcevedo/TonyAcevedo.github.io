...
// Pano2VR 5.2.4/15996
// Filename: simplex_vXtr3d_V3_1g_VR_Nov2018.ggsk
// Generated Sat Nov 17 22:35:35 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._containerflrplan.ggUpdateConditionTimer=function () {
			...
			if (me._containerflrplan.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._containerflrplan.ggCurrentLogicStatePosition == 0) {
					...
					me._containerflrplan.style.top='0px';
				}
			}
		...
		this._containermm_btns.ggLeft=-27;
		...
		this._thumbnail_button.onclick=function (e) {
			...
			me._contact_info.ggVisible = !me._contact_info.ggVisible;
			var flag=me._contact_info.ggVisible;
			me._contact_info.style[domTransition]='none';
			me._contact_info.style.visibility=((flag)&&(Number(me._contact_info.style.opacity)>0||!me._contact_info.style.opacity))?'inherit':'hidden';
			var flag=me._tn_location_box.ggPositonActive;
			if (me.player.transitionsDisabled) {
				me._tn_location_box.style[domTransition]='none';
			} else {
				me._tn_location_box.style[domTransition]='all 1000ms ease-out 0ms';
			}
			if (flag) {
				me._tn_location_box.ggParameter.rx=0;me._tn_location_box.ggParameter.ry=0;
				me._tn_location_box.style[domTransform]=parameterToTransform(me._tn_location_box.ggParameter);
			} else {
				me._tn_location_box.ggParameter.rx=0;me._tn_location_box.ggParameter.ry=-100;
				me._tn_location_box.style[domTransform]=parameterToTransform(me._tn_location_box.ggParameter);
			}
			me._tn_location_box.ggPositonActive=!flag;
		}
